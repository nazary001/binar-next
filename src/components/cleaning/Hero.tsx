...
export function CleaningHero() {
  return (
    <section className="w-full">
      {/* Same full-bleed pattern as the home / hotels / protect heroes:
          section is full-width, the left card-border bleeds to the
          screen's left edge on viewports > 1440, the photo placeholder
          grows to the screen's right edge. items-stretch (default)
          keeps both columns the same height for bottom alignment. */}
      <div className="flex flex-col items-stretch lg:flex-row">
        ...
        >
          <div
            ...
            style={{ background: "#5a6e63" }}
          >
            {/* Full-bleed image — replaces the previous "card-in-frame"
                layout (p-3/p-5/lg:p-0 + lg:h-[750px] lg:w-[856px]) which
                left a #5a6e63 frame around the photo. object-cover crops
                the photo to always fill the column on every viewport. */}
            <img
