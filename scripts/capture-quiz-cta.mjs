// Capture Quiz CTA section on the hotels page for Figma comparison.
...
// Quiz CTA is the section with id="contact-form"
...
console.log(`Quiz CTA: ${box.h}h at y=${box.y}`);
...
await page.screenshot({
  path: path.resolve("./.figma-review/hotels/quiz-cta-rendered.png"),
  type: "png",
