// Capture the StarRequestStrip section at 1440 for Figma comparison.
...
// StarRequestStrip is the 4th section (Hero, Zones, Benefits, StarStrip)
...
console.log(`Strip: ${box.w}x${box.h} at y=${box.y}`);
...
await page.screenshot({
  path: path.resolve("./.figma-review/hotels/star-strip-rendered.png"),
  type: "png",
